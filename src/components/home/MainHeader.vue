<template>
  <div class="section-header text-center my-8 py-2">
    <div class="text-uppercase caption mb-4 grey--text text--darken-2" v-if="false">
      Explora los datos
    </div>
    <h2 class="display-1 font-weight-light">
      Datos cívicos a tu alcance:<br>
      <b>Historia del presupuesto participativo</b>
    </h2>
    ...
    <div class="text-center red--text text-h2">
      ¡Conoce qué proyectos se llevaron a cabo en tu colonia!
    </div>
  </div>
</template>
